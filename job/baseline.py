...
weights_dir = "/scratch/scratch6/akansh12/DeepEXrays/model_agree_three"
...
np.save("/storage/home/akansh12/Vin-ChestXR-Abnormality-detection/model/train_loss_hist_agree_three.npy", np.array(train_loss_history))
np.save("/storage/home/akansh12/Vin-ChestXR-Abnormality-detection/model/test_loss_hist_agree_three.npy", np.array(val_loss_history))
np.save("/storage/home/akansh12/Vin-ChestXR-Abnormality-detection/model/train_AUC_hist_agree_three.npy", np.array(train_AUC_history))
np.save("/storage/home/akansh12/Vin-ChestXR-Abnormality-detection/model/test_AUC_hist_agree_three.npy", np.array(val_AUC_history))
